...
public partial class DevConnectContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdComentario).HasName("PK__tb_comen__1BA6C6F402B6CBB4");
        ...
        {
            entity.HasKey(e => e.IdCurtida).HasName("PK__tb_curti__0AC033CA8C30C456");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tb_publi__3213E83FA1672799");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tb_usuar__3213E83FFA5CE991");
            ...
            entity.HasMany(d => d.IdSeguindo).WithMany(p => p.IdUsuarioSeguidor)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("IdUsuarioSeguidor", "IdSeguindo").HasName("PK__tb_segui__44E9DBEDF03965E9");
